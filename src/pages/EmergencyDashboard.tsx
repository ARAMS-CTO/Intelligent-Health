    ...
    return (
        <div className="bg-slate-900 min-h-screen text-white p-4 md:p-8 font-mono">
            <div className="container mx-auto">
                ...
                {/* Voice Dictation (New) */}
                <div className="mb-8 bg-slate-800 border-l-4 border-red-500 p-4">
                    <h3 className="text-sm uppercase tracking-widest text-slate-400 mb-2 font-bold">Voice Command / Quick Note</h3>
                    <ClinicalVoiceRecorder
                        specialty="emergency"
                        compact={false}
                        onNoteGenerated={(note) => showToast.info("Note logged: " + note.substring(0, 30) + "...")}
                    />
                </div>
