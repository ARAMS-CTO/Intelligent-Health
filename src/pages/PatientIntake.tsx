            ...
            <div className="bg-background min-h-screen flex items-center justify-center">
                <div className="container mx-auto max-w-2xl p-8">
                    <div className="bg-surface p-8 rounded-lg shadow-xl text-center animate-fade-in">
                        ...
                        <h2 className="text-2xl font-bold text-text-main mb-2">{t('patientIntake.success_title', 'Submission Successful!')}</h2>
                        <p className="text-text-muted mb-6">{t('patientIntake.success_desc', 'Patient profile for {{name}} has been successfully created.', { name: submittedPatientName })}</p>
                        <div className="flex justify-center gap-4">
                            ...
                            >
                                {t('patientIntake.return_dashboard', 'Return to Dashboard')}
                            </button>
                            <button
                            ...
                            >
                                {t('patientIntake.submit_another', 'Submit Another Form')}
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div className="glass-card p-8 rounded-3xl shadow-xl antigravity-target border-white/20 dark:border-slate-700">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <select value={formData.sex} onChange={e => handleDirectChange('sex', e.target.value)} className={`${inputFieldClasses} appearance-none`}>
                                            <option>{t('patientIntake.male', 'Male')}</option>
                                            <option>{t('patientIntake.female', 'Female')}</option>
                                            <option>{t('patientIntake.other', 'Other')}</option>
                                            <option>{t('patientIntake.preferNotToSay', 'Prefer not to say')}</option>
                                        </select>
                        ...
                        <fieldset className="border border-slate-200/50 dark:border-slate-700/50 p-6 rounded-2xl bg-white/30 dark:bg-slate-800/30 backdrop-blur-sm">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                                <div>
                                    <label className={labelClasses}>{t('patientIntake.bloodType', 'Blood Type')}</label>
                                    <div className="relative">
                                ...
                                <div>
                                    <label className={labelClasses}>{t('patientIntake.height', 'Height (cm)')}</label>
                                    <input
                                        type="number"
                                ...
                                <div>
                                    <label className={labelClasses}>{t('patientIntake.weight', 'Weight (kg)')}</label>
                                    <input
                                        type="number"
                                ...
                                <div>
                                    <label className={labelClasses}>{t('patientIntake.allergies', 'Allergies (comma-separated)')}</label>
                                    <input
                                        type="text"
                                ...
                                <div className="md:col-span-2">
                                    <label className={labelClasses}>{t('patientIntake.baselineIllnesses', 'Baseline Illnesses (comma-separated)')}</label>
                                    <input
                                        type="text"
                        ...
                        <fieldset className="border border-slate-200/50 dark:border-slate-700/50 p-6 rounded-2xl bg-white/30 dark:bg-slate-800/30 backdrop-blur-sm">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                                <div>
                                    <label className={labelClasses}>{t('patientIntake.phone', 'Phone Number')}</label>
                                ...
                                <div>
                                    <label className={labelClasses}>{t('patientIntake.email', 'Email Address')}</label>
                                ...
                                <div className="md:col-span-2">
                                    <label className={labelClasses}>{t('patientIntake.address', 'Home Address')}</label>
                        ...
                        <fieldset className="border border-slate-200/50 dark:border-slate-700/50 p-6 rounded-2xl bg-white/30 dark:bg-slate-800/30 backdrop-blur-sm">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
                                <div>
                                    <label className={labelClasses}>{t('patientIntake.fullName', 'Full Name')}</label>
                                ...
                                <div>
                                    <label className={labelClasses}>{t('patientIntake.relationship', 'Relationship')}</label>
                                ...
                                <div>
                                    <label className={labelClasses}>{t('patientIntake.emergencyPhone', 'Phone Number')}</label>
                        ...
                        <fieldset className="border border-slate-200/50 dark:border-slate-700/50 p-6 rounded-2xl bg-white/30 dark:bg-slate-800/30 backdrop-blur-sm">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                                <div>
                                    <label className={labelClasses}>{t('patientIntake.physicianName', 'Primary Care Physician Name')}</label>
                                ...
                                <div>
                                    <label className={labelClasses}>{t('patientIntake.physicianPhone', 'Physician Contact Number')}</label>
