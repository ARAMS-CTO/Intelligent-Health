...
const Toast: React.FC<{ notification: AppNotification; onDismiss: () => void }> = ({ notification, onDismiss }) => {
  ...
  return (
    <div className="bg-surface rounded-xl shadow-2xl p-4 flex items-start gap-4 w-full max-w-sm animate-slide-in-right border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 z-[9999]">
