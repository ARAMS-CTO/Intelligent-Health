...
gcloud logging read "resource.type=cloud_run_revision AND resource.labels.service_name=intelligent-health-app" --limit 50 --format="value(textPayload)" --project=intelligent-health-ai
echo "---------------------------------------------------------"
