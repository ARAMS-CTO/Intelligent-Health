...
def seed_marc():
    ...
    try:
        ...
        if not user:
            ...
            print(f"Updating User password: {email}")
        ...
        profile.bio = (
            ...
            "He specializes in general dentistry, knee surgeries (correction: Implantology focus), "
            "and teeth cleaning and polishing. Dr. Tournon speaks both English and French."
        )
        ...
        # We'll use a local artifact or placeholder for now
        profile.clinic_logo_url = "/artifacts/happiness_clinic_logo_1769440615548.png"
        profile.profile_picture_url = "https://happinessclinic.ae/wp-content/uploads/2020/01/Dr-Marc-Tournon.jpg" # Try to use real one if valid, else placeholder
